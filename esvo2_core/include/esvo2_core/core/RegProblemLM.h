#ifndef ESVO2_CORE_CORE_REGPROBLEMLM_H
#define ESVO2_CORE_CORE_REGPROBLEMLM_H
...
struct RegProblemLM : public factor::OptimizationFunctor<double>
{
  struct Job
  {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  std::vector<int> VisualizationIdx_;
  TimeSurfaceObservation* pTsObs_;
  RefFrame* ref_;
  CurFrame* cur_;
...
#endif //ESVO2_CORE_CORE_REGPROBLEMLM_H